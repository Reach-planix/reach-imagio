    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            REACH Imagio converts simple plans, renders, and interior photos into polished visuals suitable for presentations and marketing. Every project appears carefully curated and professionally finished.
          </p>
