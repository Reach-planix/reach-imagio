    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            The platform works as the finishing stage after modelling or drafting tools. Technical drawings and renders can be refined with annotations, highlights, and graphic overlays.
          </p>
