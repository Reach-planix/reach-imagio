    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Enhanced visuals such as coloured plans and refined renders help clients quickly understand spatial concepts and design ideas. Clear presentations reduce confusion and speed up approval decisions.
          </p>
