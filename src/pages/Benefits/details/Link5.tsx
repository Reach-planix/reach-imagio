    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            High-quality imagery prepared for websites, social media, brochures, and portfolios helps interior professionals present their work more effectively and attract new clients.
          </p>
