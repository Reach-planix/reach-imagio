    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            REACH Imagio allows designers to build structured moodboards that communicate design direction clearly. Professional layouts make concept presentations feel strategic and well thought out.
          </p>
